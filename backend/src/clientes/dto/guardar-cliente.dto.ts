...
export class GuardarClienteDto {
  ...
  @MaxLength(40, { message: 'El documento del cliente no puede exceder 40 caracteres' })
  documento?: string;

  @IsOptional()
  @IsString({ message: 'El telefono del cliente debe ser texto' })
  @MaxLength(40, { message: 'El telefono del cliente no puede exceder 40 caracteres' })
  telefono?: string;
}
