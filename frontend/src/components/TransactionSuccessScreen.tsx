        ...
        <section className="mx-auto flex min-h-[calc(100dvh-3rem)] w-full max-w-[430px] flex-col">
          <header className="flex items-center gap-3 pb-4">
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-[#102d92] shadow-sm dark:bg-slate-900 dark:text-blue-100"
              aria-label="Volver a la pantalla de éxito"
            >
              <ArrowLeft size={18} />
            </button>
            <div>
        ...
        <section className="mx-auto flex min-h-[calc(100dvh-3rem)] w-full max-w-[430px] flex-col">
          <header className="flex items-center gap-3 pb-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-black">{history.title}</h1>
